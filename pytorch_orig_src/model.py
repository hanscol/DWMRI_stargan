...
class Generator(nn.Module):
    ...
    def __init__(self, conv_dim=64, c_dim=4, repeat_num=6):
        ...
        layers = []
        layers.append(nn.Conv3d(15+c_dim, conv_dim, kernel_size=7, stride=1, padding=3, bias=False))
        ...
        layers.append(nn.Conv3d(curr_dim, 15, kernel_size=7, stride=1, padding=3, bias=False))
