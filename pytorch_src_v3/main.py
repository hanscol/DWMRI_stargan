...
if __name__ == '__main__':
    ...
    parser.add_argument('--crop_size', type=int, default=48, help='crop size for the CelebA dataset')
    ...
    parser.add_argument('--resume_iters', type=int, default=8000, help='resume training from this step')
