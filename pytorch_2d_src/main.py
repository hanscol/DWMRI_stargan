...
if __name__ == '__main__':
    ...
    parser.add_argument('--crop_size', type=int, default=96, help='crop size for the CelebA dataset')

    parser.add_argument('--image_size', type=int, default=96, help='image resolution')
